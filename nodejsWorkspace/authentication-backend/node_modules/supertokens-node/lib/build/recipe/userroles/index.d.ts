// @ts-nocheck
import Recipe from "supertokens-node/lib/build/recipe/userroles/recipe";
import { RecipeInterface } from "supertokens-node/lib/build/recipe/userroles/types";
export default class Wrapper {
    static init: typeof Recipe.init;
    static PermissionClaim: import("supertokens-node/lib/build/recipe/userroles/permissionClaim").PermissionClaimClass;
    static UserRoleClaim: import("supertokens-node/lib/build/recipe/userroles/userRoleClaim").UserRoleClaimClass;
...
export { UserRoleClaim } from "supertokens-node/lib/build/recipe/userroles/userRoleClaim";
export { PermissionClaim } from "supertokens-node/lib/build/recipe/userroles/permissionClaim";
